        ...
        <div className="flex-1 overflow-y-auto space-y-2 pr-1">
          {items.map(({ event, occurrenceDate }, idx) => (
            <button
              ...
              className="w-full text-left p-3 rounded-lg bg-slate-50 hover:bg-slate-100 transition-colors border-l-2 group border border-slate-200"
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                ...
                {event.recurrence_rule && <span className="text-[10px] text-slate-400">↻</span>}
              </div>
