...
export const TREATMENTS: TreatmentInfo[] = [
  ...
  },
  {
    ...
    price: 'from £299',
    duration: '30–45 min',
    description: 'Precision hyaluronic acid filler treatment to add volume, define the lip border, and create a naturally beautiful shape — avoiding the "overfilled" look.',
  ...
  },
  {
    ...
    price: 'from £450',
    duration: '30–45 min',
    description: 'Profhilo is a high-concentration hyaluronic acid treatment injected at specific bio-aesthetic points to deeply hydrate skin, stimulate collagen and elastin production.',
  ...
  },
  {
    ...
    price: 'from £180',
    duration: '30–45 min',
    description: 'Medically-graded acids exfoliate damaged surface skin, revealing a brighter, smoother complexion underneath. Available in light, medium, and deep strengths.',
  ...
  },
  {
    ...
    price: 'from £450',
    duration: '75–90 min',
    description: 'The ultimate rejuvenation combo — microneedling channels allow PRP growth factors to penetrate deeply, amplifying collagen stimulation for transformative results.',
...
// All known names that can appear in chat messages
export const TREATMENT_NAMES = TREATMENTS.map(t => t.name);
export const MEMBERSHIP_NAMES = MEMBERSHIPS.map(m => m.tier);
