    ...
    <Card padding="none">
      ...
      <div className="divide-y divide-surface-100">
        {notifications.length === 0 ? (
          <div className="flex flex-col items-center py-8 text-surface-400 gap-2">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  !n.read ? "bg-brand-50/30" : "hover:bg-surface-50"
                )}
              >
                <div className={cn("mt-0.5 p-1.5 rounded-lg", typeStyles[n.type])}>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-surface-500 truncate mt-0.5">{n.description}</p>
                </div>
