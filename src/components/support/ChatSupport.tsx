  ...
  return (
    <Card className="flex flex-col h-[500px]" padding="none">
      <div className="px-5 py-4 border-b border-surface-100 flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium text-surface-900">NeuraSolutions Support</p>
      ...
      <div className="flex-1 overflow-y-auto p-5 space-y-4">
        {messages.map((msg) => (
          ...
          >
            ...
            >
              <p>{msg.content}</p>
              <span className={cn("text-[10px] mt-1 block", msg.sender === "client" ? "text-white/70" : "text-surface-400")}>
      ...
      <div className="p-4 border-t border-surface-100">
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 rounded-xl border border-surface-200 bg-surface-50 px-4 py-2.5 text-sm text-surface-900 placeholder:text-surface-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
          />
