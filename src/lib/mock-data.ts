...
export const mockReports: Report[] = [
  ...
  { id: "rpt_002", title: "Q1 2026 Executive Summary", type: "quarterly", category: "executive", period: "Q1 2026", generatedAt: "2026-04-05T10:00:00Z", size: "5.1 MB", pdfUrl: "#", summary: "Executive summary covering Q1 2026 performance, ROI analysis, and strategic recommendations. Overall platform ROI reached 312%.", highlights: ["312% platform ROI", "$2.84M revenue influenced", "8,470 tasks automated", "5.2% engagement rate improvement"], aiGeneratedNote: "The platform delivered exceptional Q1 results with a 312% ROI. The integration of AIOS Voice Transcription in March adds significant voice-to-text capability. Consider upgrading to Enterprise tier to unlock multi-language voice support." },
